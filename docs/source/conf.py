...
#
# oboyo documentation build configuration file, created by
...
# version = oboyo.__version__.split('post')[0]
# The full version, including alpha/beta/rc tags.
# release = oboyo.__version__
release = '0.1.0'
